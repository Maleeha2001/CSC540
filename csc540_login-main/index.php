...
<body>
  <div class="login-card text-center">
    ...
    <form action="./php/authenticate.php" method="post">
      <div class="mb-3">
        <input type="text" class="form-control bg-dark text-white border-secondary" placeholder="Username" name="username" required>
      </div>
      <div class="mb-4">
        <input type="password" class="form-control bg-dark text-white border-secondary" placeholder="Password" name="password" required>
      </div>
